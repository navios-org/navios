...
export function envInt(key: keyof NodeJS.ProcessEnv, defaultValue: number): number {
...
>(
  ...
  return (env[key] || process.env[key] || defaultValue || undefined) as Ensured extends true
    ? string
    : string | undefined
}
