...
- **Stable Release**: First stable release of @navios/openapi
  - Production-ready OpenAPI integration for Navios framework
  - Automatic OpenAPI schema generation from Navios endpoints
