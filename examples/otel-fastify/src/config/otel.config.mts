import type { FastifyOtelPluginOptions } from '@navios/otel-fastify'

/**
 * Parse environment variables to build OTEL configuration.
 * All values can be configured via environment variables.
 */
export function getOtelConfig(): FastifyOtelPluginOptions {
  ...
  const config: FastifyOtelPluginOptions = {
    // Service identification
    serviceName: env.OTEL_SERVICE_NAME || 'otel-fastify-example',
 ...
 */
export function logOtelConfig(config: FastifyOtelPluginOptions): void {
